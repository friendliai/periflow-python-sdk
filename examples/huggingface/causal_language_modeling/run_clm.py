...
class DataTrainingArguments:
    ...
    dataset_saved_dir: Optional[str] = field(
        default=None, metadata={"help": "The local directory where the desired dataset is saved in advance."}
    )
...
def main():
    ...
    # Define a callback class to use Periflow
    class PeriflowCallback(TrainerCallback):
        def on_init_end(self, args, state, control, **kwargs):
            pf.init(total_train_steps=None)
